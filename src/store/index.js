  ...
  state: {
    ...
    products: [{
      ...
      },
      {
        ...
        drow: false,
        description: `את שקי השתילה של שמריהו אנחנו ממלאים לכם בידיים. הם מכילים קומפוסט (3/1) ותערובת שתילה (2/3), והם מושלמים להזנת השתילים שלכם בכל מה שנדרש להם. את התחושה הממכרת של ריקון השק לתוך האדנית, עם כל ניחוחות האדמה שהוא מעלה – אי אפשר להחליף!!!`,
        description1: `אדנית היא מכל לטיפוח צמחים המיועד להצבה על אדן חלון של בתים. בתוך אדנית מצע לגידול צמחים, בדרך כלל עפר מדושן, ובו נזרעים או נשתלים צמחים פרחוניים. נועדה לנוי ולקישוט הבית, מבחוץ ומבפנים.
