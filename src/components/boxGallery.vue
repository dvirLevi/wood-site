<template>
  <div class="row row-title pb-5 pt-5">
    <div class="img-bac img-cover" :style="{backgroundImage: `url(${item.img})`}">
    ...
    <div class="col center">
      <div class="text p-3">
        ...
        <h4 v-if="ifShowText">שמריהו הוא מותג אדניות עץ ישראלי. אנחנו בונים אותן בקפדנות עם חומרי הגלם האיכותיים ביותר, ושולחים אותן במהירות עד לביתכם</h4>
