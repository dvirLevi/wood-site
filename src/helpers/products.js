const products = [{
  ...
  description1: `
  <p>אדניות רוטשילד עשויות עץ אורן פיני מלא שעבר הקצעה וחיטוי.</p>
  <p>ניתן להזמין את האדניות במגוון גדלים ובמגוון צבעים.</p>
  <p>האדניות מיוצרות בישראל, עוברות בקרת איכות קפדנית, ונשלחות כשהן מורכבות ומוכנות לשימוש.</p>
  `,
  description2: `
  <p>מידות חיצוניות בס"מ (אורךXרוחבXגובה):</p>
  ...
  `,
  description3: `
  <p>בשמריהו אנחנו משתמשים בצבעים הטובים ביותר!</p>
  <p>לבחירתך <a href="https://www.realmilkpaint.com/real-milk-paint-colors/">10 צבעים</a> של חברת THE REAL MILK PAINT, מטנסי, ארה"ב.</p>
  <p>אבל אנחנו לא מסתפקים בזה! את שטח האדנית הפנימי, זה שבא במגע עם האדמה והצמחים,
  אנחנו צובעים בשמן טאנג טבעי, שחודר לתוך העץ ומקנה לו עמידות מושלמת לתנאי חוץ.</p>
  <p>השמן מאושר על ידי ה-FDA למגע עם אוכל ומזון.</p>
  `,
  color: true,
  size: 2,
  addCart: false,
