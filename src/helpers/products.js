const products = [{
  ...
  },
  {
    ...
    description: `סט אדניות קטנות ושובבות, מושלמות לסוקולנטים ולצמחי צל. את האדניות תוכלו להציב על השולחן במשרד, במטבח, או סתם על המדרגות בכניסה לבית. ארלוזורוב עשויות בפרופורציות מושלמות, מעץ מלא משובח.`,
    description1: `
  <p>אדניות ארלוזורוב עשויות עץ אורן פיני מלא שעבר הקצעה וחיטוי. ניתן להזמין את האדניות במגוון גדלים ובמגוון צבעים. האדניות מיוצרות בישראל, עוברות בקרת איכות קפדנית, ונשלחות כשהן מורכבות ומוכנות לשימוש.</p>
  `,
    description2: `
  <p class="font-weight-bold">מידות חיצוניות בס"מ (אורךXרוחבXגובה):</p>
